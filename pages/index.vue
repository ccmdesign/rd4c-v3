<template>
  <div>
    <rd-hero>
      <h4 class="brow">GovLab</h4>
      <h1>Responsible Data for Children</h1>
      <h3>Guidance, tools and leadership to support the responsible handling of data for and about children.</h3>
      <base-button visual="primary" color="primary">Join the Conversation</base-button>
    </rd-hero>
    ...
    <base-section>
      ...
      <p>Welcome to Responsible Data for Children.</p>
