<template>
  <div>
    ...
    <div class="aux">
      ...
      <p>The Responsible Data for Children initiative regularly releases videos explaining its work and the work of its partners. Here’s a few of our video series that you might be interested in. If you would like to stay up to date with our latest releases, please subscribe to our YouTube channel or fill out the form here.</p>
      <h3>RD4C Bites & Lessons from the Field</h3>
      <p>Short videos highlighting responsible data practices from governments, UN offices, research centers, and other partners around the world.</p>
      <h3>Recorded Webinars and Lectures</h3>
      <p>Recordings of our efforts to train data professionals and disseminate the Responsible Data for Children approach</p>
